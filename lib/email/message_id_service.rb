  ...
  class MessageIdService
    class << self
      ...
      def find_post_from_message_ids(message_ids)
        ...
        # TODO (martin) It would be good to weight these in some way...the best
        # one to use is outbound_message_id since it should be the most canonical
        # use of the Message-ID, whether the post was created from an incoming
        # email or by a user.
